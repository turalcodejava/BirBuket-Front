import { BarChart3, Boxes, ClipboardList, Home, LogOut, MessageCircle, Settings, Users, Sparkles, Gift, FolderOpen } from 'lucide-react';
...
const adminMenu = [
  ...
  { to: '/admin/categories', label: 'Kateqoriyalar', icon: FolderOpen },
